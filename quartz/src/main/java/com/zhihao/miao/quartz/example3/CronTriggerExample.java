...
package com.zhihao.miao.quartz.example3;
...
public class CronTriggerExample {
  ...
  //job3每个1分钟的15s执行一次，但是是在早上8点到晚上17点之间执行
    ...
    //job 4是每个3分钟执行一次，并且是在晚上17点到晚上23点之间执行
